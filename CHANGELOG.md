...
- Ability to buy CCD through Transak

### Changed

- Now, the current account is selected by default for a WalletConnect session proposal,
  instead of the one with the highest balance
...
- Delegation Register pool screen UI bugs
...
- Ability to pay with protocol-level tokens on connected sites
...
[1.16.1]: https://github.com/Concordium/cryptox-android/compare/1.16.0...1.16.1
...
[1.15.1]: https://github.com/Concordium/cryptox-android/compare/1.15.0...1.15.1

[1.15.0]: https://github.com/Concordium/cryptox-android/compare/1.14.0...1.15.0
