...
class ImportResultView : FrameLayout {
    private val binding =
        ViewImportResultBinding.inflate(LayoutInflater.from(context), this, true)
    ...
    fun setAddressBookData(importResult: ImportResult) {
        ...
        binding.readonlyDivider.visibility = View.GONE
        binding.headerIdTextview.visibility = View.GONE
        binding.transferTimeTextview.setText(R.string.import_confirmed_recipient_accounts)
        ...
        binding.contentTextview.text = strBuilder.toString()
    ...
    fun setIdentityData(identityImportResult: ImportResult.IdentityImportResult) {
        ...
        binding.transferTimeTextview.setText(R.string.import_confirmed_accounts)
    ...
    private fun addReadOnlyAccounts(identityImportResult: ImportResult.IdentityImportResult) {
        ...
        binding.readonlyContentTextview.text = strBuilder.toString()
    }
}
